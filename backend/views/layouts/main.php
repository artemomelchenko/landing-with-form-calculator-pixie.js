...
<!--                        <h3>General</h3>-->
                        ...
                        \yiister\gentelella\widgets\Menu::widget(
                            [
                                "items" => [
                                    ["label" => "Рабочее пространство", "url" => "/admin", "icon" => "columns"],
                                    ["label" => "Товары", "url" => ["products/index"], "icon" => "shopping-cart"],
                                    ["label" => "Настройки", "url" => ["settings/index"], "icon" => "wrench"],
                                    ["label" => "Отзывы", "url" => ["reviews/index"], "icon" => "comments"],
                                    ["label" => "Назначения", "url" => ["applications/index"], "icon" => "font-awesome"],
//                                    [
//                                        "label" => "Widgets",
//                                        "icon" => "th",
//                                        "url" => "#",
